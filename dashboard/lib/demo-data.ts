...
export const demoDashboardData: DashboardData = {
  ...
  devices: [
    ...
    { device_id: "bed-01", status: "online", last_seen_at: observedAt },
  ],
  latest_sensors: [
    ...
    { id: 5, device_id: "petzone-01", sensor_type: "food_weight", value: 742, unit: "g", observed_at: observedAt },
    { id: 6, device_id: "petzone-01", sensor_type: "water_weight", value: 512, unit: "g", observed_at: observedAt },
    { id: 7, device_id: "bed-01", sensor_type: "temperature", value: 23.8, unit: "C", observed_at: observedAt },
    { id: 8, device_id: "bed-01", sensor_type: "humidity", value: 51, unit: "%", observed_at: observedAt },
    { id: 9, device_id: "bed-01", sensor_type: "bed_pressure_left", value: 1042, unit: "adc", observed_at: observedAt },
    { id: 10, device_id: "bed-01", sensor_type: "bed_pressure_center", value: 1398, unit: "adc", observed_at: observedAt },
    { id: 11, device_id: "bed-01", sensor_type: "bed_pressure_right", value: 1156, unit: "adc", observed_at: observedAt },
  ],
  camera: {
    state: "online",
    fps: 11.8,
