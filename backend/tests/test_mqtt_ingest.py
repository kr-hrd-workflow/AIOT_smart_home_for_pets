...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("bed-01", "temperature", 22.0, "C"),
        ("bed-01", "humidity", 48, "%"),
        ("bed-01", "bed_pressure_left", 101, "adc"),
        ("bed-01", "bed_pressure_center", 102, "adc"),
        ("bed-01", "bed_pressure_right", 103, "adc"),
    ],
)
...
def test_malformed_time_request_is_ignored_before_normal_ingestion() -> None:
    ingress = RecordingIngress()
    client = FakeClient()
    ingestor = MqttIngestor(
        ingress=ingress,
